function createDisplay(array) {
    for (let product of array) {
        ...
        document.getElementById('card').innerHTML += createCard(name,descritption,price,img)

    }
}

function createCard(name,description,price,img){
return '<div class="col-md-4 mb-5">' +
    ...
    '<div class="card-footer">'+
        '<a href="#" class="btn btn-warning">Achetez moi!</a>'+
    '<p>'+ price +'</p>'+
    '</div>'
    +
    '</div>' +
